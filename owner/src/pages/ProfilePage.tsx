    ...
    <div className="page">
      ...
      <section className="panel" data-animate>
        <div className="panel-header">
          <div>
            <h3>Profile</h3>
            <p>Manage your owner account and security settings.</p>
          </div>
          <div className="row">
