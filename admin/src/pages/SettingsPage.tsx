...
const NOTIFICATION_KEY = 'cr_admin_notifications'
...
function SettingsPage() {
  ...
  const displayEmail = profile?.email || 'admin@carrental.app'
  const displayRole = profile?.role ? profile.role[0].toUpperCase() + profile.role.slice(1) : 'Administrator'
    ...
    <div className="page settings-page">
      <div className="settings-hero">
        <div>
          ...
          <h2>Shape your admin workspace</h2>
          <p className="muted">
            Personalize how the admin console looks, feels, and communicates with you.
          </p>
        </div>
      ...
      <div className="settings-grid">
        ...
        <section className="panel settings-card">
          <div className="panel-header">
            <div>
              <h3>Notifications</h3>
              <p>Choose how operations updates and alerts reach you.</p>
            </div>
          </div>
          <div className="settings-row">
            <div>
              <p className="row-title">Email summaries</p>
              <p className="muted">Weekly operations and revenue recaps.</p>
            </div>
          ...
          <div className="settings-row">
            <div>
              ...
              <p className="muted">Instant flags for critical booking issues.</p>
            </div>
            <label className="toggle">
              <input
                type="checkbox"
